...
**Phase:** v0.2.3 (hybrid bash + slim TS). Release gated on `docs/VPS_TEST_RESULTS.md` matrix evidence (Hetzner CX22 Ubuntu 22.04/24.04, DigitalOcean Debian 12) + mobile pairing flow. Browser terminal bridge deferred to a later release. This file is the build-time briefing.
